...
<form method="post" class="cart-form" id="addToCartForm">
  ...
  <!-- BUY NOW -->
  <a 
    class="btn buy <?= $product['stock'] == 0 ? 'disabled' : '' ?>" 
    href="<?= $product['stock'] > 0 ? 'buy-now.php?id='.$product['id'] : '#' ?>"
    onclick="<?= $product['stock'] == 0 ? 'showOutOfStockDialog(); return false;' : '' ?>">
    Buy Now
  </a>
