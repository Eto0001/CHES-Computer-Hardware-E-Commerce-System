...
// Handle delete (with image removal)
if (isset($_GET['del'])) {
    $id = intval($_GET['del']);
    ...
    // Redirect to same page without query params to avoid resubmission
...
$perPage = 8; // items per page — adjust as needed
$offset = ($page - 1) * $perPage;

$whereSql = '';
$params = [];

// If search query provided, filter by product name or category name
if ($q !== '') {
  ...
  <main class="container">
    ...
    <?php else: ?>
      ...
      <div class="pagination" aria-label="Pagination">
        <?php
          // Build base URL preserving search query
        ...
        <?php
          // show page range (e.g., show up to 7 pages centered on current)
          $maxLinks = 7;
